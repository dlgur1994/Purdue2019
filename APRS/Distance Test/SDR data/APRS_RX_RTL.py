...
class APRS_RX_RTL(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/sdr/yun/gr-APRS/Examples/RF_signal_test_002', False)
        self.blocks_file_sink_0_0.set_unbuffered(True)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, '/home/sdr/yun/gr-APRS/Examples/AF_signal_test_002', False)
        ...
        self.msg_connect((self.epy_block_0, 'ax25 out'), (self.blocks_message_debug_0, 'print_pdu'))
        ...
        self.connect((self.fft_filter_xxx_1, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.fft_filter_xxx_1, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.pfb_decimator_ccf_0, 0), (self.blocks_file_sink_0_0, 0))
