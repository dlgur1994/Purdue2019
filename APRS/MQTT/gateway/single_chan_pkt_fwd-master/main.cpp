...
uint32_t  freq = 902300000; // in Mhz! (868.1)

// Set location
float lat=40.42629500;
float lon=-86.90921800;
int   alt=0;
...
#define SERVER2 "192.168.2.62"      // local
...
//---------------------------------------------------------
//	printf("addr : " + currentAddr);
//	printf("-------------------------------------------------");

/*	FILE *fp = NULL;	
	fp = fopen("./addresslog.bin", "ab");
	
	if(fp != NULL){
		fwrite(currentAddr, sizeof(char), currentAddr, fp);
		fclose(fp);
	}
*/
        //-----------------------------------------------------
